...
from datahandler.constants import GENERATE_CONFIG_DESC, NUM_PARTIES_DESC, \
...
if __name__ == '__main__':
    ...
    folder_configs = os.path.join("", "configs")
    ...
    config_model = import_module('{}.generate_configs'.format(model))
