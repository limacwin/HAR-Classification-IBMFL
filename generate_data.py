...
from datahandler.load_data import load_wisdm

from datahandler.constants import GENERATE_DATA_DESC, NUM_PARTIES_DESC, DATASET_DESC, PATH_DESC, PER_PARTY, \
...
def save_wisdm_party_data(nb_dp_per_party, should_stratify, party_folder):
    """
    Saves WISDM party data
    ...
    (x_train, y_train), (x_test, y_test) = load_wisdm()
...
save_wisdm_party_data(points_per_party, stratify, folder)
